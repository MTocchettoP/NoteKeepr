...
CREATE TABLE `Awaiting_Registration`(
    ...
    CONSTRAINT `FK_UserID` FOREIGN KEY (`UserID`) REFERENCES `User` (`Username`) ON DELETE CASCADE ON UPDATE CASCADE
);
...
INSERT INTO `User` VALUES ('admin', 'password', 'cprg352+admin@gmail.com', 1,1, 'Bob', 'Bobberson', 1, 1);
INSERT INTO `User` VALUES ('admin2', 'password', 'cprg352+admin2@gmail.com', 0,1, 'Admin2', 'Admin2', 1, 1);

INSERT INTO `user` VALUES ('comp1', 'password', 'cprg352+comp1@gmail.com', 1,1, 'Jean-Luc', 'Picard', 3, 2);
INSERT INTO `user` VALUES ('user1', 'password', 'cprg352+user1@gmail.com', 1,1, 'William', 'Riker', 2, 2);
INSERT INTO `user` VALUES ('user2', 'password', 'cprg352+user2@gmail.com', 1,1, 'Geordi', 'La Forge', 2, 2);
INSERT INTO `user` VALUES ('user3', 'password', 'cprg352+user3@gmail.com', 0,1, 'Wesley', 'Crusher', 2, 2);
--INSERT INTO `User` VALUES ('sd', 'password', 'sdtestsait@gmail.com', 1,1, 'SDy', 'McSDyface', 2,2);

INSERT INTO `user` VALUES ('comp2', 'password', 'cprg352+comp2@gmail.com', 1,1, 'Princess', 'Celestia', 3, 3);
INSERT INTO `user` VALUES ('user4', 'password', 'cprg352+user4@gmail.com', 1,1, 'Twinkle', 'Sparkle', 2, 3);
INSERT INTO `user` VALUES ('user5', 'password', 'cprg352+user5@gmail.com', 1,1, 'Pinkie', 'Pie', 2, 3);
INSERT INTO `user` VALUES ('user6', 'password', 'cprg352+user6@gmail.com', 0,1, 'Rainbow', 'Dash', 2, 3);
